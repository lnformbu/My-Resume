...
<div class="resume-container">
      ...
      <div class="row">
        ...
        <div class="col-md-5 offset-lg-1">
          <div class="row mt-2">
            ...
            <div class="col-sm-7">
              <div class="pb-2">Frederick, MD, USA 21703. </div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="shadow-1-strong bg-white my-5 p-5" id="skills">
    <div class="skills-section">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3"><span class="fw-bolder">Kubernetes & Monitoring tools</span>
          ...
          <div class="mb-3"><span class="fw-bolder">Jenkins (CI/CD) / Ansible </span>
            <div class="progress my-2 rounded" style="height: 20px">
          ...
          <div class="mb-3"><span class="fw-bolder">Terraform / Nexus </span>
            <div class="progress my-2 rounded" style="height: 20px">
          ...
          <div class="mb-3"><span class="fw-bolder">AWS / Tomcat / JBoss /  </span>
            <div class="progress my-2 rounded" style="height: 20px">
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3"><span class="fw-bolder">Maven / Sonarqube </span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-info" role="progressbar" data-aos="zoom-in-right" data-aos-delay="200" data-aos-anchor=".skills-section" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">Expert</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Linux / Windows / MacOS</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="400" data-aos-anchor=".skills-section" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">Master</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Shell Scripting / JavaScript </span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-info" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">Master</div>
            </div>
          </div>
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Senior Devops Engineer<span class="text-muted h6">at Landmark Technologies</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">Oct 2018 - Present</div>
            <div>Involved in CI/CD process and integrated GIT, Nexus, SonarQube, and Maven artifacts built with Jenkins and creating Docker image and using the Docker image to deploy over EKS (Kubernetes).</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="200">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">AWS DevOps Engineer <span class="text-muted h6">at Cerquat Llc</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">Aug 2016 - Oct 2018 </div>
            <div>Integrated GIT as Version Control tool, Jenkins as continuous integration tool and Nexus repository for storing the Docker images. Worked on Container orchestration using Kubernetes. Installing and designing Kubernetes clusters.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="400">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Network Cloud Security Engineer <span class="text-muted h6">at Alibaba</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">Jun 2013 - Aug 2016</div>
            <div>I implemented, deployed, and maintained security access solutions and update current identity and security access solutions to include the cloud-based solutions.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="education-section">
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-success" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">BS - Cyber Security & Computer Networks <span class="text-muted h6">from University of Maryland Global Campus</span>          </div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">2011 - 2013</div>
            <div>operational procedures and technologies to design, implement, administer, secure, and troubleshoot corporate networks while applying cybersecurity principles operationally.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-success" data-aos="fade-in" data-aos-delay="200">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">AAS - Cyber Security <span class="text-muted h6">from Montgomery Community College</span>          </div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">2007 - 2011</div>
            <div>Emphasis on computer security and information assurance concepts, augmented with current industry standard techniques. Attention to threats and vulnerabilities, prevention at the technical (hardware and software) and human levels, detection, response, and management aspects of security.</div>
           </div>
         </div>
        </div>
      </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-left" data-aos-delay="100">
          <div class="m-4 mt-md-2">
            ...
            <h3>Build 1</h3>
            <p class="text-muted">Jenkins integration with Maven, SonarQube, Docker and Kubernetes.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-left" data-aos-delay="100">
          <div class="m-4 mt-md-2">
            <p class="text-teal text-small">Environment Layout</p>
            <h3>Build 3</h3>
            <p class="text-muted">3. Jenkins integration with Maven, SonarQube, Ansible and Docker.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="shadow-1-strong bg-white my-5 p-5" id="">
